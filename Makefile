...
CFLAGS = -mmcu=$(MCU) -DF_CPU=$(F_CPU) -Os -Wall -Wextra -std=c11 \
         -Iinclude -Ihal -Idrivers/gpio -Idrivers/uart -Isrc -Idrivers/millis -Idrivers/spi -Idrivers/74hc595 -Idrivers/led -Idrivers/keypad -Idrivers/buzzer -Idrivers/pwm -Idrivers/servo -Idrivers/i2c -Idrivers/rtc -Idrivers/mfrc522rfid -Idrivers/keyscan
...
SRCS = \
	...
	drivers/mfrc522rfid/mfr_2.c\
	drivers/keyscan/keyscan.c
